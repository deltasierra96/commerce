    ...
    <div className='relative overflow-hidden'>
      ...
      >
        <div className='mx-auto max-w-2xl lg:max-w-none'>
          ...
          <p className='mx-auto mt-4 max-w-xl text-xl text-neutral-600'>
            Most of our products are limited releases that won't come back. Get your favorite items
            while they're in stock.
          </p>
          <div className='mt-6'>
            <ButtonLink variant='filled' color='primary' size='lg' href='/'>
            ...
            {testimonials.map((testimonial) => (
              <blockquote key={testimonial.id} className='sm:flex lg:block'>
                ...
                <div className='mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10'>
                  <p className='text-lg text-neutral-600'>{testimonial.quote}</p>
                  <cite className='mt-4 block font-semibold not-italic text-neutral-900'>
